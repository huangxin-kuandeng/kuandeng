iD.svg.Divider = function(projection, context) {
    ...
    return function drawLines(surface, graph, entities, filter) {
        ...
        _.forOwn(pathdata, function(v, k) {
            onewaydata[k] = _(v)
                .filter(function(d) { return d.isOneWay() && iD.Layers.getLayer(d.layerId, d.modelName).display; })
