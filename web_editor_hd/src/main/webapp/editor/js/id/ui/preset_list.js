iD.ui.PresetList = function(context) {
    ...
    function presetList(selection) {
        ...
        if (context.entity(id).isUsed(context.graph())) {
            messagewrap.append('button')
                ...
                .append('span')
                .attr('class', 'KDSEditor-icon forward');
        } else {
            messagewrap.append('button')
                .attr('class', 'close')
                .on('click', function() {
        ...
        searchWrap.append('span')
            .attr('class', 'KDSEditor-icon search');
        ...
        var list = listWrap.append('div')
            .attr('class', 'preset-list KDSEditor-fillL cf')
    ...
    function CategoryItem(preset) {
        ...
        function item(selection) {
            var wrap = selection.append('div')
                .attr('class', 'preset-list-button-wrap category KDSEditor-col12');
            ...
            box = selection.append('div')
                .attr('class', 'subgrid KDSEditor-col12')
            ...
            sublist = box.append('div')
                .attr('class', 'preset-list KDSEditor-fillL3 cf KDSEditor-fl');
        }
    ...
    function PresetItem(preset) {
        function item(selection) {
            var wrap = selection.append('div')
                .attr('class', 'preset-list-button-wrap KDSEditor-col12');
