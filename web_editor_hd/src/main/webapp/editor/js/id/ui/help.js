    ...
    function help(selection) {
        ...
        function clickHelp(d, i) {
            ...
            if (i > 0) {
                ...
                prevLink.append('span').attr('class', 'KDSEditor-icon back blue');
            ...
            if (i < docs.length - 1) {
                ...
                nextLink.append('span').attr('class', 'KDSEditor-icon forward blue');
            }
        }
        ...
        button.append('span')
            .attr('class', 'KDSEditor-icon help light');
