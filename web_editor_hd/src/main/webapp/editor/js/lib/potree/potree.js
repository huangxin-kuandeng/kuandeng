 ...
 * @Date: 2019-08-09 15:14:07
 * @LastEditors: tao.w
 * @LastEditTime: 2021-06-08 14:37:03
 * @Description: 
 */
 ...
 * @LastEditors: tao.w
 * @LastEditTime: 2021-06-07 20:36:05
 * @Description: 
 */
...
Potree.MeasuringTool = class MeasuringTool extends THREE.EventDispatcher {
	...
	startInsertion(args = {}) {
		...
		domElement.removeEventListener('mouseup', this.mouseupCallback, false);
		...
		cancel.callback = (e,isdbclick) => {
            ...
            domElement.removeEventListener('mousedown', mousedownCallback, false);
            if(isdbclick){
                this.viewer.dispatchEvent({
                    type: 'measure_added',
                    measure,
		...
		if (measure.maxMarkers > 1) {
			...
			domElement.addEventListener('mousedown', mousedownCallback, false);
            domElement.addEventListener('mouseup', this.mouseupCallback, false);
