 ...
 * @LastEditors: tao.w
 * @LastEditTime: 2021-04-12 18:10:42
 * @Description: 
 */

iD.operations.rTsLaneDelete1 = function (selectedIDs, context) {
    ...
    var operation = function () {
        ...
        context.perform(iD.actions.DeleteMultiple(rids, context), t('operations.rTsLane1.delete_relation'));
    ...
    operation.tooltip = function () {
        return t('operations.rTsLane1.delete_relation');
    };

    operation.id = 'rPgLaneDelete1';
    operation.keys = [];
    operation.title = t('operations.rTsLane1.delete_relation');
