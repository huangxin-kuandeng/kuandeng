 ...
 * @LastEditors: tao.w
 * @LastEditTime: 2020-03-06 14:21:10
 * @Description: 
 */
 ...
 * @return: 
 */ 
iD.operations.rDividerSinDelete = function(selectedIDs, context) {
    var relationName = iD.data.DataType.R_DIVIDER_SIGN;
    ...
    var operation = function () {
        ...
        context.perform(iD.actions.DeleteMultiple(rids, context), t('operations.rDividerSign.delete_relation'));
    ...
    operation.tooltip = function () {
        return t('operations.rDividerSign.delete_relation');
    };

    operation.id = 'delete';
    operation.keys = [iD.ui.cmd('D')];
    operation.title = t('operations.rDividerSign.delete_relation');
