iD.ui.TagEditor.LaneAttributeTagEditor = function(context) {

    var dispatch = d3.dispatch('change');

    function tagEditor(selection, opts) {
		
        var tpl = iD.ui.TagEditorTpl.LaneAttribute(),
            tags = opts.tags,
            entityID = opts.id,
    ...
    tagEditor.available = function(entity) {
        return entity.modelName == iD.data.DataType.LANE_ATTRIBUTE;
    }
