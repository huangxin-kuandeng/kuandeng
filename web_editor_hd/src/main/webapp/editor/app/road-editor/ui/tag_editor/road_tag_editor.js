iD.ui.TagEditor.RoadTagEditor = function(context) {

    var dispatch = d3.dispatch('change');

    function roadTagEditor(selection, opts) {

        var tpl = iD.ui.TagEditorTpl.Road(),
            tags = opts.tags,
            entityID = opts.id,
...
//          fieldHash[fields[i].fieldName].readOnly = readOnly;
        }
    ...
    roadTagEditor.available = function(entity) {
        // return entity instanceof iD.Way;
        return entity instanceof iD.Way && entity.modelName === iD.data.DataType.ROAD;
        ...
        */
        ...
        function renderOtherFiels(selection,tpl,opts){
            ...
            divItem.append("div").text(function(d,i){return d.fieldTitle}).attr({"class":"left"}).attr("title",function(d,i){return d.fieldTitle});
    ...
    return d3.rebind(roadTagEditor, dispatch, 'on');
};