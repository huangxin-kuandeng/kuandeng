iD.ui.TagEditor.RoadCrossTagEditor = function(context) {

    var dispatch = d3.dispatch('change');

    function roadCrossTagEditor(selection, opts) {

        var tpl = iD.ui.TagEditorTpl.RoadCross(),
            tags = opts.tags,
            entityID = opts.id,
        ...
        if (currentLayer.isRoad() && currentLayer.typeModelEntity) {
    ...
    roadCrossTagEditor.available = function(entity) {
    ...
    */
    ...
    //         //tpl中不存在
    //         if(!fieldInTpl(k,tpl) && v.fieldTitle!=""){
    //             var field={};
    ...
    */
    ...
    return d3.rebind(roadCrossTagEditor, dispatch, 'on');
};