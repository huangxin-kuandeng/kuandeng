    ...
    Pagination.prototype = {
        ...
        bindEvent: function(){
            ...
            function creatBtns(ismorePosition){
                ...
                var prevbtn = '<span class="pagination-btn iconfont iconarrow-lift" id="pagination-prev"></span>';
                var nextbtn = '<span class="pagination-btn iconfont iconarrow-right" id="pagination-next"></span>'
                if(this._currentPage == 1){
                    firstbtn = '<li class="pagenum pagination-btn pagination-current" data-num="1">1</li>';
                    prevbtn = '<span class="pagination-btn pagination-disabled iconfont iconarrow-lift" id="pagination-prev"></span>'
                }
                if(this._currentPage == this._btnNum){
                    ...
                    nextbtn = '<span class="pagination-btn pagination-disabled iconfont iconarrow-right" id="pagination-next"></span>'
                }
