 ...
 * @LastEditors: tao.w
 * @LastEditTime: 2019-09-16 17:07:00
 * @Description: 
 */
...
Potree.loadPointCloud = function (path, name, callback,cloudUrl) {
 ...
 */
Potree.POCLoader.load = function load(url, callback, dataUrl) {
    try {
 ...
 * @Date: 2019-08-09 15:14:07
 * @LastEditors: tao.w
 * @LastEditTime: 2019-09-11 17:54:25
 * @Description: 
 */
...
Potree.Measure = class Measure extends THREE.Object3D {
    ...
    update() {
		...
		// console.log(this.name, this._render)
        this._render = false;
        if (this.points.length === 0) {
            return;
        ...
        for (let i = 0; i <= lastIndex; i++) {
            ...
            if(this.showDistances && this.edgeLabels[i])
            { // edge labels
            ...
            if(this.showAngles && this.angleLabels[i])
            { // angle labels
        ...
        if(this.heightLabel && this.heightEdge)
        { // update height stuff
        ...
        if(this.showArea && this.areaLabel)
        { // update area label
 ...
 * @LastEditors: tao.w
 * @LastEditTime: 2019-08-31 19:49:13
 * @Description: 
 */
...
Potree.Scene = class extends THREE.EventDispatcher {
    ...
    initialize() {
        ...
        { // background
			...
			this.sceneBG.fg_texture_1.image = this.fg_image;
 ...
 * @LastEditors: tao.w
 * @LastEditTime: 2019-09-16 21:42:31
 * @Description: 
 */
...
Potree.Viewer = class PotreeViewer extends THREE.EventDispatcher {
    ...
    setImageOpacity(value) {
        ...
        if (this.scene.sceneBG.fg_material_1.opacity != value) {
            this.scene.sceneBG.fg_material_1.opacity = value;
        }
    };
...
//      return this.scene.fg_material.opacity;
        return this.scene.sceneBG.fg_material_1.opacity;
    }
...
//              this.renderer.render(this.scene.sceneFG, this.scene.cameraFG);
//          }
