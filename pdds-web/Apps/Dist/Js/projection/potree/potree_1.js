 ...
 * @LastEditors: tao.w
 * @LastEditTime: 2019-09-04 16:29:02
 * @Description: 
 */
/**
		...
		if (this.drag) {
			...
			if (this.drag.object && isDrawing) {
				...
				for (let inputListener of this.getSortedListeners()) {
					...
					if (this.hoveredElements[0] && this.hoveredElements[0].object instanceof THREE.Line) {
						let measure = this.hoveredElements[0].object.parent;
						inputListener.dispatchEvent({
							type: 'edge_click',
							measure: measure,
							button: e.button
 ...
 * @Date: 2019-08-09 15:14:07
 * @LastEditors: tao.w
 * @LastEditTime: 2019-12-20 10:51:53
 * @Description: 
 */
...
Potree.Measure = class Measure extends THREE.Object3D {
    ...
    addMarker(point, opt = {}) {
        ...
        { // edges
            ...
            // var resolution = new THREE.Vector2(viewer.renderArea.clientWidth, viewer.renderArea.clientHeight);
            ...
            //     // near: viewer.scene.getActiveCamera().near,
            //     // far: viewer.scene.getActiveCamera().far
            // });

            // var edge = new THREE.Mesh(g.geometry, material);
            // edge.visible = true;
            // edge.editable = this.editable;
            // edge.geo = lineGeometry;
            // edge.g = g;
 ...
 * @Date: 2019-09-05 17:20:02
 * @LastEditors: tao.w
 * @LastEditTime: 2019-12-24 16:16:06
 * @Description: 
 */
 ...
 * @LastEditors: tao.w
 * @LastEditTime: 2019-12-24 16:26:57
 * @Description: 
 */
    ...
    constructor(domElement, args = {}) {
        ...
        try {
            ...
            this.classifications = {
                ...
                13: { visible: true, name: 'road surface' }
            };
 ...
 * @LastEditors: tao.w
 * @LastEditTime: 2019-09-17 14:03:36
 * @Description: 
 */
initSidebar = (viewer) => {
	...
	function initClassificationList () {
		...
		addClassificationItem(13, 'road surface');
	}
