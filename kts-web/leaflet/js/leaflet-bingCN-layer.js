...
L.TileLayer.Bing = L.TileLayer.extend({
  ...
  initialize: function (options) {
    ...
    this._fetch = this._metaDataOnLoad(options);
  ...
  _metaDataOnLoad: function (_option) {
    this._url = _option.bingMapsKey || "https://ecn.{subdomain}.tiles.virtualearth.net/tiles/a{quadkey}.jpeg?g=587&mkt=en-gb&n=z";
    this._imageryProviders = [];
